...
Memory Thread beta.3.3 · Story Journal. Основная ролевая модель получает только выбранную часть памяти в пределах заданного бюджета, а полный архив продолжает храниться отдельно.`);}
